...
export const logTic = functions.https.onRequest(async (req: { headers: { authorization: string; }; body: { date: any; timeOfDay: any; location: any; intensity: any; latitude: any; longitude: any; }; }, res: { status: (arg0: number) => { (): any; new(): any; send: { (arg0: { error?: string; success?: boolean; }): any; new(): any; }; }; }) => {
    cors(req, res, async () => {
...
export default getAdviceFromChatGPT;
