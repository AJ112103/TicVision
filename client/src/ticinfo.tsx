...
const CardContent = ({
  ...
  <div className={`${className} text-[#256472]`} {...props}>
    {children}
  </div>
);
    ...
    <div className="min-h-screen bg-[#c6e8f0]">
      <main className="container mx-auto px-6 py-8">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-[#256472]">Tic Definitions</h1>
        </motion.div>
        ...
        <Card className="mb-6">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <AlertCircle className="w-5 h-5 text-[#256472]" />
              What are Tics?
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="mb-6">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Layers className="w-5 h-5 text-[#256472]" />
              Types of Tics
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <p className="flex items-start gap-2">
                <ChevronRight className="w-4 h-4 text-[#256472]" />
                <span>
        ...
        <Card className="mb-6">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Volume2 className="w-5 h-5 text-[#256472]" />
              Vocal Tics
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              ...
              <p>
                <strong>Vocal Coprolalia:</strong> Involuntary outbursts of socially inappropriate or obscene words or phrases.
              </p>
              <p>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Activity className="w-5 h-5 text-[#256472]" />
              Motor Tics
            </CardTitle>
          </CardHeader>
          <CardContent>
